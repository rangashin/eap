<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Manage "Scholarname here" files') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    ...
                    <div class="max-w-2xl">
                        <div class="flex mb-4">
                            <x-text-input class="mt-1 block w-full mr-3 flex-1 bg-slate-200" type="text" value="{{ __('MarkJayManrique_SchoolRegform1.jpg') }}" disabled />
                            <a href="{{ __('registration_form') }}" target="_blank">
                                <x-primary-button class="mt-2 bg-red-700">Delete</x-primary-button>
                            </a>
                        </div>
                        <div class="flex mb-4">
                            <x-text-input class="mt-1 block w-full mr-3 flex-1 bg-slate-200" type="text" value="{{ __('MarkJayManrique_SchoolRegform2.jpg') }}" disabled />
                            <a href="{{ __('registration_form') }}" target="_blank">
                                <x-primary-button class="mt-2 bg-red-700">Delete</x-primary-button>
                            </a>
                        </div>
                        <div class="flex mb-4">
                            <x-text-input class="mt-1 block w-full mr-3 flex-1 bg-slate-200" type="text" value="{{ __('MarkJayManrique_SchoolRegform3.jpg') }}" disabled />
                            <a href="{{ __('registration_form') }}" target="_blank">
                                <x-primary-button class="mt-2 bg-red-700">Delete</x-primary-button>
                            </a>
                        </div>
                        <div class="flex mb-4">
                            <x-text-input class="mt-1 block w-full mr-3 flex-1 bg-slate-200" type="text" value="{{ __('MarkJayManrique_SchoolRegform4.jpg') }}" disabled />
                            <a href="{{ __('registration_form') }}" target="_blank">
                                <x-primary-button class="mt-2 bg-red-700">Delete</x-primary-button>
                            </a>
                        </div>
                    ...
                    <div class="max-w-2xl">
                        <div class="flex mb-4">
                            <x-text-input class="mt-1 block w-full mr-3 flex-1 bg-slate-200" type="text" value="{{ __('SchoolReportCard1.jpg') }}" disabled />
                            <a href="{{ __('report_card') }}" target="_blank">
                                <x-primary-button class="mt-2 bg-red-700">Delete</x-primary-button>
                            </a>
                        </div>
                        <div class="flex mb-4">
                            <x-text-input class="mt-1 block w-full mr-3 flex-1 bg-slate-200" type="text" value="{{ __('SchoolReportCard2.jpg') }}" disabled />
                            <a href="{{ __('report_card') }}" target="_blank">
                                <x-primary-button class="mt-2 bg-red-700">Delete</x-primary-button>
                            </a>
                        </div>
                        <div class="flex mb-4">
                            <x-text-input class="mt-1 block w-full mr-3 flex-1 bg-slate-200" type="text" value="{{ __('SchoolReportCard3.jpg') }}" disabled />
                            <a href="{{ __('report_card') }}" target="_blank">
                                <x-primary-button class="mt-2 bg-red-700">Delete</x-primary-button>
                            </a>
                        </div>
                        <div class="flex mb-4">
                            <x-text-input class="mt-1 block w-full mr-3 flex-1 bg-slate-200" type="text" value="{{ __('SchoolReportCard4.jpg') }}" disabled />
                            <a href="{{ __('report_card') }}" target="_blank">
                                <x-primary-button class="mt-2 bg-red-700">Delete</x-primary-button>
                            </a>
                        </div>
