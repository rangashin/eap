                ...
                <div class="">
                    <section>
                        <header>
                            ...
                            <div class="p-6  mr-3 bg-green-100  rounded-lg border border-gray-200 shadow-md  dark:bg-gray-800 dark:border-gray-700 content-center ">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">SCHOLAR STATUS:</h5>
                                <p class=" font-normal text-2xl text-gray-700 dark:text-gray-400">{{ __('Burat') }}</p>    
                            </div>
                            <br>
