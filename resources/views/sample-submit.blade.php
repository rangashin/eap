                    ...
                    <table class="min-w-full border-collapse block md:table text-sm text-gray-500">
                        ...
                        <tbody class="block md:table-row-group">
                            <tr class="bg-white border border-grey-500 md:border-none block md:table-row hover:bg-gray-50">
                                ...
                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell lg:text-base md:text-base sm:text-sm xs:text-xs uppercase"><span class="inline-block w-1/3 md:hidden font-bold">Attached File:</span><input aria-describedby="file_input_help" id="file_input" type="file" name="file_input_scholar_report" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" /></td>
