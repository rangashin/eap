                    ...
                    <div class="max-w-xl">
                        @if ($applicant->renewal == 'NEW')
                            ...
                            <!-- Upload Baptismal Cert -->
                                ...
                                <x-text-input class="mt-1 block w-full bg-slate-200" type="text" value="{{ !empty($applicant->getFirstMedia('baptismal_new')->file_name) ? $applicant->getFirstMedia('baptismal_new')->file_name : null}}" disabled/>
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input class="mt-1 block w-full bg-slate-200" type="text" value="{{ !empty($applicant->getFirstMedia('birth_new')->file_name) ? $applicant->getFirstMedia('birth_new')->file_name : null}}" disabled/>
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input class="mt-1 block w-full bg-slate-200" type="text" value="{{ !empty($applicant->getFirstMedia('regi_report_new')->file_name) ? $applicant->getFirstMedia('regi_report_new')->file_name : null }}" disabled/>
                        ...
                        @elseif ($applicant->renewal == 'OLD')
                            <div class="mb-4">
                                ...
                                <x-text-input class="mt-1 block w-full bg-slate-200" type="text" value="{{ !empty($applicant->getFirstMedia('regi_old')->file_name) ? $applicant->getFirstMedia('regi_old')->file_name : null}}" disabled/>
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input class="mt-1 block w-full bg-slate-200" type="text" value="{{ !empty($applicant->getFirstMedia('report_old')->file_name) ? $applicant->getFirstMedia('report_old')->file_name : null}}" disabled/>
