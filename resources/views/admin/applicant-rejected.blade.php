                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('admin.applicant.rejected.index') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Rejected</a>
                                </div>
                            </li>
                        </ol>
                    </nav>
                            ...
                            <tbody>
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="py-4 px-6 space-x-4">
                                        <x-a-link href="{{ route('admin.applicant.review.show', $applicant->user_id) }}">   
                                            {{ __('View') }}
                                        </x-a-link>
                                    </td>
                                </tr>
