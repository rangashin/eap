                        ...
                        <div class="grid grid-cols-2 ">
                            ...
                            <div class="mr-6">
                                <div class="w-full p-4 my-3 mx-3  bg-white border rounded-lg shadow-md sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                                    <form id="confirm-save" action="{{ route('admin.year-update') }}" method="post">
                                        @csrf
                                        <div class="flex items-baseline flex-wrap">
                                            ...
                                            <x-primary-button type="button" onclick="confirmSave('confirm-save')" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base px-6 py-3.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" id="submissionbutton">
                                                {{ __('Save') }}
                                            </x-primary-button>
                                ...
                                <div class="w-full p-4 my-3 mx-3 bg-white border rounded-lg shadow-md sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                                    <form id="confirm-changes" action="{{ route('admin.submission-update') }}" method="post">
                                        @csrf
                                        <div class="mb-3 ml-3">
                                        ...
                                        <div class="grid justify-items-center ml-3">
                                            <x-primary-button type="button" onclick="confirmChanges('confirm-changes')" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                                {{ 'Confirm Changes' }}
                                            </x-primary-button>
                                        </div>
                                    </form>
